...
```typescript
// Detect memory leaks in Windsurf client usage
...
class WindsurfConcurrencyChecker {
...
### Evidence Attached
- [ ] Debug bundle (windsurf-advanced-debug-*.tar.gz)
...
## Next Steps
For load testing, see `windsurf-load-scale`.